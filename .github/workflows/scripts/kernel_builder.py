...
# === KASAN disabled (debug-only sanitizer, not meant for daily-driver
# kernels - also the actual source of the ThinLTO verifier crash in
# lib/maple_tree.c on android15-6.6+: an injected __asan_handle_no_return()
# call ends up missing debug-info location metadata under ThinLTO) ===
CONFIG_KASAN=n
